...
def html_to_xhtml2(html_unicode_string):
    """
    ADDED BY ME
    Does nothing
    ...
    # Add xmlns attribute to html node
    unicode_string = re.sub(r'<html class="client-nojs" dir="ltr" lang="en">',r'<html xmlns="http://www.w3.org/1999/xhtml" class="client-nojs" dir="ltr" lang="en" xml:lang="en">',html_unicode_string)
    return unicode_string
